...
export class DataService {
  ...
  getUsers(){
    ...
    return this.http.get('https://api.jsonbin.io/b/5ebd73ef8284f36af7bb2587/1', {headers})
  }
  ...
  updateUser(amigo){
    ...
    this.http.put("https://api.jsonbin.io/b/5ebd73ef8284f36af7bb2587/1",amigo,{headers})
    .subscribe(
        (val) => {
